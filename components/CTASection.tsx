      ...
      >
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-white transition-all hover:-translate-y-0.5 hover:bg-primary-hover active:scale-[0.97]"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-primary-light px-6 py-3 text-sm font-semibold text-text-primary transition-all hover:-translate-y-0.5 hover:bg-primary-light-hover active:scale-[0.97]"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-full border-2 border-text-primary px-6 py-3 text-sm font-semibold text-text-primary transition-all hover:-translate-y-0.5 hover:bg-dark-hover hover:text-white active:scale-[0.97]"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
