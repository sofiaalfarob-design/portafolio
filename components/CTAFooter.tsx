        ...
        <div className="mx-auto max-w-container px-6 text-center">
          ...
          >
            <a
              ...
              className="rounded-full bg-primary px-8 py-3.5 text-sm font-semibold text-white transition-all hover:-translate-y-0.5 hover:bg-primary-hover active:scale-[0.97]"
            >
              Schedule a Call
            </a>
            <a
              href="#projects"
              className="rounded-full border-2 border-gray-600 px-8 py-3.5 text-sm font-semibold text-white transition-all hover:-translate-y-0.5 hover:border-white active:scale-[0.97]"
            >
              See Portfolio
            </a>
            <a
        ...
        <div className="mx-auto flex max-w-container flex-col items-center justify-between gap-4 px-6 py-6 md:flex-row">
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              href="#"
              aria-label="Twitter"
              className="text-gray-500 transition-all duration-200 hover:scale-110 hover:text-white"
            >
